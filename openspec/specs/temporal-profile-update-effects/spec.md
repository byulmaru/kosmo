# temporal-profile-update-effects Specification

## Purpose

Committed Local Profile의 federation-visible 변경 뒤 stable identity의 Temporal Workflow가 최신
`Update(Person)` projection을 Fedify queue에 handoff하는 책임과 실패 경계를 정의한다.
