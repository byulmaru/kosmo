# temporal-namespace-provisioning Specification

## Purpose

Kosmo 환경이 외부 관리 접속 경로 없이 cluster-internal Temporal frontend를 사용해 logical namespace의 name, owner와 retention을 선언하고 멱등 준비하는 배포 경계를 정의한다.
