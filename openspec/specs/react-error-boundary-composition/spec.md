# react-error-boundary-composition Specification

## Purpose

Android·iOS·Web 공용 앱의 production 오류 경계를 함수형 조합으로 유지하고, 기존 fallback·복구 동작과 React class component 재도입 방지 계약을 정의한다.
