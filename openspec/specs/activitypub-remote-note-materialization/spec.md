# activitypub-remote-note-materialization Specification

## Purpose

검증된 원격 ActivityPub Note의 exact identity와 attribution 작성자를 확인하고, 허용된 원문을 기존 Post·Media·Reply 저장 경계로 원자적으로 최초 materialize하는 계약을 정의한다.
