# activitypub-remote-follow Specification

## Purpose

TBD - created by archiving change add-activitypub-remote-follow. Update Purpose after archive.
...
- **THEN** the separate short Unfollow command uses the exact deleted Follow source ID and directed pair to enqueue the outbound Undo and does not reopen the completed pair lifecycle Workflow
