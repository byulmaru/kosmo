# hashtag-related-profile-api Specification

## Purpose

로그인한 Account가 정확한 Hashtag identity와 이미 저장된 Profile Tag 관계를 바탕으로 공개 조회 가능한 관련 Profile을 원격 materialization 없이 안정적으로 탐색하는 API 계약을 문서화한다.
