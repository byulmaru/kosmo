# fedify-postgres-message-queue-runtime Specification

## Purpose

TBD - created by archiving change configure-fedify-postgres-message-queue-runtime. Update Purpose after archive.
