# profile-mute Specification

## Purpose

영구 Profile Mute의 저장·권한·활성 판정과 Owner 전용 GraphQL 관리 계약을 정의한다.
콘텐츠 목록별 적용 정책은 post capability를 따르며 기존 관계·상호작용·알림 상태는 보존한다.
