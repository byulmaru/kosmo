# activitypub-remote-profile-media Specification

## Purpose

원격 ActivityPub actor의 embedded avatar와 header 표현을 원본 Remote Profile 소유의 Ready Remote Media와
ProfileMedia 관계로 원자적으로 materialize하고 동기화하는 계약을 정의한다.
