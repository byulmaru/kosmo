# activitypub-outbound-reaction Specification

## Purpose

Local Profile의 built-in Reaction을 호환 ActivityPub `Like`·`EmojiReact`·`Undo`로 투영하고, Remote Post Author에게 commit 이후 직접 전달하는 계약을 정의한다.
