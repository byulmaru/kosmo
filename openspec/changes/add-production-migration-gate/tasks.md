...
- [ ] 1.1 Tagged release metadata와 live recovery/workload evidence를 운영자 JSON 입력 없이 자동 조립하고 검증하는 callable migration gate interface를 구현한다.
...
- [ ] 1.9 최신 Linear와 repository policy를 다시 대조해 PROD-562/563/565 범위가 포함되지 않았는지 확인한 뒤 PROD-564 구현 PR을 Ready로 갱신한다.
