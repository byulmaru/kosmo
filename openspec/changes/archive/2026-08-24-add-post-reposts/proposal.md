...
- Repost·Quote 프레젠테이션, 목록·상세 renderer별 direct Source 표시와 canonical Source 이동을 제공한다. 순수 Repost의 body·timestamp와 직접 상세 URL은 Source detail로 이동하고, 그 아래 Action Bar도 화면에 표시한 direct Source를 대상으로 동작한다. 단, direct Source가 Quote인 순수 Repost의 표시 깊이와 canonical 이동은 PROD-828로 분리한다.
