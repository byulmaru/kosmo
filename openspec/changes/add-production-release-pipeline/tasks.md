...
- [x] 2.2 승인 뒤 검증된 identity로 `kosmo-prod` sync를 실행하고 PROD-564 preflight·contract approval hash·completion interface로 같은-digest migration 성공을 기다리는 pipeline을 구현한다.
