...
- [ ] 7.3 PROD-450 Storybook/component interaction에서 supplied option 동작과 border·radius·selected layer·fading arc pending overlay·error·disabled 미렌더링을 검증하고 app check를 통과시킨다.
