...
- [x] 6.2 공용 surface의 상태·경계 component test
- [x] 6.3 공용 PostMediaViewerSurface 구현
- [x] 6.4 Controls/Actions/대표 상태 Storybook catalog
- [x] 6.5 boundary movement와 sensitive reveal interaction contract
- [x] 6.6 focused/full 자동화, Web Storybook readback, 독립 review
