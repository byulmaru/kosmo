...
Android·iOS·Web 공용 앱의 production 오류 경계가 class component 없이 기존 fallback·복구·관측 조합 계약을 유지하고, CI lint가 새 React class component를 차단한다.
...
- 선택적 reporter는 error와 React component stack을 받고, 공용/Native 코드는 Web Sentry 구현을 import하지 않는다.
