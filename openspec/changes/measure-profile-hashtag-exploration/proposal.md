...
- raw 도메인 값은 custom property에 추가하지 않고 표준 SDK metadata와 identify/reset을 유지한다.
...
고정 합성 자료의 손계산 값과 실제 PostHog 집계를 대조하고, 운영 환경의 인수는 실제 선행 증거를 확인한 뒤 마친다.
...
- User agreement: PROD-556의 2026-09-03 승인 댓글 `88fa293a-616e-47d5-81fa-ede269ce3c3a`; 이번 spec workflow 명시 호출.
