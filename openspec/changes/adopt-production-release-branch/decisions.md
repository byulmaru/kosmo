...
- 없음. 이 change에는 더 이상 active decision이 없으며, production source·approval·manual release·live cutover의 남은 결정은 `PROD-783`가 소유한다. 표시용 release tag 공급과 version label 재활성화는 별도 후속 범위다.
