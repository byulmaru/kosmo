...
- Completed foundations: [PROD-341](https://linear.app/byulmaru/issue/PROD-341)의 versioned PostContent document 계약과 PROD-357의 activity-neutral inbox 책임 정렬이 main에 병합되어 이 spec-only change의 시작 조건을 충족했다.
