...
- 저장된 remote profile은 GraphQL Node 조회 대상으로 열어두되, 기존 handle 조회, 검색, 목록, UI 연결, active profile 선택, follow/unfollow/viewerFollow 동작, `Profile.posts` 확장은 local profile 중심으로 유지한다.
