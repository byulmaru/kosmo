...
- [ ] 5.2 기존 production surface 소유 경계 안에서 목록·상세 링크 복사를 복구하고 canonical origin·direct Source·guest·More item 순서·dismiss·실패 재시도 계약을 유지한다.
- [ ] 5.3 성공·실패·menu dismiss와 일반 Post·Quote·순수 Repost·guest 경로를 증명하는 가까운 component 또는 E2E 회귀 검증을 추가한다.
