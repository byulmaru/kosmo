...
- **WHEN** 사용자가 Web의 `PostListItem` 위에 pointer를 올린다
...
- **THEN** semantic `statePressed` overlay가 hover보다 우선해 표시되고 release·cancel·leave 뒤 남은 상태 또는 resting fill로 돌아간다
