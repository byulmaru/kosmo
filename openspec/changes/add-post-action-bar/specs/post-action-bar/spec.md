...
- **THEN** 현재 `PostLayout`은 48px Avatar와 12px gap의 Header 뒤 8px 간격으로 Body를 full width에 배치하고, metadata 하단부터 8px 뒤에 Engagement를 같은 왼쪽 경계와 너비로 배치한다
