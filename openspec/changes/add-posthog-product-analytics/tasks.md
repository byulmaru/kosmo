...
- [x] 5.1 Cloud US project의 공개 project token·ingestion host build/deployment 주입 경계를 정렬하고 조회·관리 권한 credential이 repository·CI log·build provenance·image artifact에 포함되지 않는다는 증거를 기록한다.
