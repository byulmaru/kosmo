...
- mobile Web drawer는 이름·chevron 내부 content의 6px 광학 보정과 Web 전용 open chevron만 변경한다. trigger
...
- [x] 1.10 사용자의 Mobile Web Storybook 시각 확인을 반영해 이름·chevron 내부 content를 4px에서 6px 아래로
      조정한다. 기존 Universal Mobile Storybook에서 text·icon center의 6px offset과 open 전후 trigger·navigation
      geometry 불변을 검증하고 Android/iOS 경로를 유지한다.
