...
- [ ] 1.1 닫힌 260px full profile summary를 유지하면서 picker를 summary 바로 아래의 anchored absolute overlay로
...
- [ ] 1.5 기존 Shell Storybook 영역의 10개 이상 typed profile fixture에서 full overlay의 navigation 위치 불변과
      outside dismissal을 추가 검증하고 compact surface·기존 선택·생성 interaction과 actor-flow E2E를 유지한다.
- [ ] 1.6 관련 typecheck·Storybook test/build·기존 profile-switcher E2E를 다시 통과시키고 1280·1440px full
