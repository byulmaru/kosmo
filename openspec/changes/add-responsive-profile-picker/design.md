...
별개로 명시적으로 전달한다. `ProfileSwitcher`는 trigger, Relay action state, list/footer content와 full의 고정
260px summary composition을 소유한다. `SidebarNavigation`은 surface와 제어 상태만 전달하고 summary renderer나
