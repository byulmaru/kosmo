...
- **AND** 프로덕션 GraphQL endpoint는 validation 또는 variable coercion failure를 공통 generic error로 마스킹해 authorization code, PKCE verifier, access token 또는 ID token을 echo하지 않는다
