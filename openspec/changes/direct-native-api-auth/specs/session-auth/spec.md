...
- **THEN** application-generated response payload, client bundle, log, 새 Kosmo session record에 OIDC client secret, authorization code, PKCE verifier, access token 또는 ID token을 포함하지 않는다
