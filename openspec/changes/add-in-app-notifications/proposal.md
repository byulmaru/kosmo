...
- `apps/api`: shared discriminator를 위한 kind-aware Node resolution, Notification interface/concrete object/connection, membership 기반 Profile 목록·visible Unread count, Read mutation, schema와 resolver/service test.
