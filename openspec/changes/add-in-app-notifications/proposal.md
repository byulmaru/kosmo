...
- `packages/core`: Notification enum, 단일 Drizzle table/migration, 저장·정책 경계와 ProfileFollow 생성·삭제 action 연결.
- `apps/api`: concrete typename 기반 Notification Node resolution, Notification interface/concrete object/connection, membership 기반 Profile 목록·visible Unread count, Read mutation, schema와 resolver/service test.
