...
- 저장, 생성·삭제 API, 목록 API, viewer-relative 조회 API, 목록 UI를 `PROD-396`, `PROD-408`, `PROD-409`, `PROD-410`, `PROD-420`, `PROD-421`의 독립 구현·검증 단위로 나누고, 부모 `PROD-391`에서 통합 흐름과 OpenSpec archive를 소유한다.
