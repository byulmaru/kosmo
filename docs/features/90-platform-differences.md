...
| 답글           | Reply            | Reply           | Reply                        | Reply                        | 필수                 |
| 공유           | Repost           | Repost          | Boost                        | Renote                       | Mastodon식 공유 우선 |
| 인용           | Quote            | Quote           | 신중한 quote post            | Quote renote                 | MVP 제외 후보        |
| 긍정 반응      | Like             | Like            | Favourite                    | Reaction                     | 단일 반응 우선       |
| 북마크         | Bookmark         | Saved 계열 검토 | Bookmark                     | Favorite/Clip 계열           | 개인 저장 필수       |
...
| 커스텀 피드    | 추천/리스트 중심 | Custom Feed     | 리스트/태그 중심             | Antenna/Channel              | 후순위 참고          |
| 리스트         | List             | List 계열       | List                         | List 계열                    | 필수 후보            |
| 신고/차단/뮤트 | 있음             | 있음            | 강함                         | 있음                         | 필수                 |
| DM             | 있음             | 있음            | 멘션 공개범위 기반           | Direct 계열                  | 별도 DM은 후순위     |
| 파일함         | 없음             | 없음            | 첨부 중심                    | Drive                        | 후순위 참고          |
...
labeler는 강력하지만 MVP에 넣기에는 운영 모델이 크다.
...
Drive는 파일 재사용 경험을 만든다. Kosmo는 먼저 게시 첨부와 프로필 미디어를 안정화하고,
나중에 개인 파일함을 검토하는 편이 좋다.
...
- Kosmo의 MVP가 Mastodon 호환을 실제 출시 전제에 포함하는가, 아니면 로컬 SNS 골격을 먼저
  완성하는가.
