...
인용은 Repost의 하위 유형이 아니라 별도 Post 작성 모델이다. 확산과 괴롭힘 위험이 함께 있는
기능이므로 제품 포함 여부와 기본 정책은 아직 확정하지 않는다.

- Quote Post는 원본 Post를 참조하는 새 Post로 본다.
- 인용이 확산 기능으로 작동할 수 있으므로 작성자 통제와 동의 모델이 중요하다.
