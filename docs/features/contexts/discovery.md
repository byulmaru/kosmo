...
- Profile은 Remote URL 또는 Qualified Handle로 Remote Profile을 lookup할 수 있다.
...
- Trust & Safety의 Domain Limit에 걸린 원격 Domain의 Post와 Profile은 검색 후보에서 제외한다.
- Domain Block 또는 Profile 도메인 차단에 걸린 원격 Domain의 콘텐츠는 검색과 lookup에서 없는 것처럼
  취급한다.
