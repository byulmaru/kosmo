...
- 팔로우한 프로필의 Post는 Home Post List에 나타난다.
- 자기 자신은 팔로우할 수 없다.
...
- 언팔로우 후 해당 프로필의 새 Post와 Repost는 Home Post List에 들어오지 않는다.
- 이미 받은 알림은 삭제하지 않는다.
- 과거 Home Post List에 있던 Post와 Repost는 더 이상 후보가 아니므로 목록에서 사라진다.
