...
- Media는 Account의 업로드/감사 책임과 Profile의 사용 주체를 함께 기록한다. 개인 파일함과 과거
  업로드 재사용 라이브러리는 현재 Media 범위에서 제외한다.
...
- 신고 제출 주체는 Account다. Account는 해당 Account와 역할 관계가 없는 Profile을 신고할 수 있다.
