...
- viewer Profile이 작성한 eligible Original Post를 포함한다.
- viewer Profile이 팔로우한 Active/Normal Profile의 eligible Original Post를 포함한다.
...
- Target Profile이 작성한 eligible Original Post와 Repost를 포함한다.
- Reply는 포함하지 않는다.

### Hashtag Post List

- Post Visibility가 Public이고 Form이 Original이며 Target Hashtag가 포함된 eligible Post만 포함한다.
