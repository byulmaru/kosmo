...
| ------------- | ----------------- | --------- | ------ | ---------------------------------- | -------------------------------------------------------------------------------------------------- | ------------------- |
| Bookmark 추가 | Profile           | Bookmark  | Post   | `Account.Active`, `Profile.Member` | 행동 주체가 선택된 Active/Normal Profile이고 Post 조회 정책을 통과하며 같은 조합의 Bookmark가 없다 | Bookmark가 생성된다 |
