...
| ------------------- | ----------------- | -------------- | ---------------- | ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| Follow Request 생성 | Follower Profile  | Follow Request | Followee Profile | `Account.Active`, `Profile.Member`         | 두 Profile이 다르고 Active/Normal이며 Followee의 Approval Policy가 Approval Required다. 양방향 Block, Domain Block, 기존 관계/Pending 요청이 없다 | Pending Follow Request가 생성되고 대응하는 Follow Request Notification Item 생성 경계를 호출한다                                      |
