...
| Post 삭제   | Author Profile    | Post      | 없음                                                                             | `Account.Active`, `Post.Author`    | Lifecycle State가 Active다                                                                                                                                                                                                                                                                    | Lifecycle State가 Tombstone이 되고 삭제 시각이 기록된다. Form=Repost면 대응하는 Notification 제거 경계를 호출한다                                                                                   |
