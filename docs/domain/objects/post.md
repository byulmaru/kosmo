...
Post는 Profile이 작성하고 배포하는 짧은 게시 단위다. 게시 본문, Post Kind, Post Visibility, 답글/Repost/Quote
...
| ---------------- | ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------- | ------------------- | --------- |
| Content Document | Versioned JSON, nullable | `{ version, summary, body }`; V1 summary는 nullable Plain Text Content Warning이고 summary와 body Plain Text 합계가 500자 이하이며 Media가 없으면 body가 비어 있을 수 없다 | Kind가 Original, Reply 또는 Quote | Post 조회 정책 통과 | 없음      |
| Sensitive Media  | boolean, 필수            | Post에 연결된 모든 Media 표시에 함께 적용한다                                                                                                                              | Kind가 Original, Reply 또는 Quote | Post 조회 정책 통과 | 없음      |
...
| Reply Parent      | [Post](./post.md)         | Post -> Post     | 1 -> 1      | Kind가 Reply                      | Reply는 Post 조회 정책을 통과하고 Parent는 별도 조회 정책을 통과할 때 표시 | 없음             |
| Repost Source     | [Post](./post.md)         | Post -> Post     | 1 -> 1      | Kind가 Repost                     | 두 Post 조회 정책 통과                                                     | 없음             |
| Quote Source      | [Post](./post.md)         | Post -> Post     | 1 -> 1      | Kind가 Quote                      | 두 Post 조회 정책 통과                                                     | 없음             |
| Mentioned Profile | [Profile](./profile.md)   | Post -> Profile  | 1 -> 0..N   | Kind가 Original, Reply 또는 Quote | Post 조회 정책 통과                                                        | 없음             |
| Attached Media    | [Media](./media.md)       | Post -> Media    | 1 -> 0..4   | Kind가 Original, Reply 또는 Quote | Post와 Media 조회 정책 통과                                                | 없음             |
...
- Repost 취소는 별도 행동이 아니라 Kind가 Repost인 Post에 대한 Post 삭제다.
