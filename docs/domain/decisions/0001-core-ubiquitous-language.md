...
- Local/Remote 구분은 [Profile](../objects/profile.md)의 Profile Origin 상태 차원이다.
...
- `Repost`는 별도 durable 객체가 아니라 Post Form 값이다.
...
- Messaging, Quote, Collection, Follow Pack은 현재 범위에서 제외한다.
...
- [Post](../objects/post.md)는 Post Form, Post Visibility, Repost, Post Eligibility를 소유한다.
