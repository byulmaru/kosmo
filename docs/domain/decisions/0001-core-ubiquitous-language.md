...
| 재게시           | Repost          | Content와 Reply Parent 없이 Repost Source를 가진 Post 구조           |
| 인용 게시        | Quote           | Content와 Repost Source를 가진 Post 구조                             |
...
- `Reply`, `Repost`와 `Quote`는 별도 durable 객체나 배타적인 상태 값이 아니라 Post의 Content와 관계
  조합이다.
...
- [Post](../objects/post.md)는 Content와 관계 조합, Post Visibility, Repost, Quote, Post Eligibility를 소유한다.
