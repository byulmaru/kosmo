...
| 인용 게시        | Quote           | 자체 본문 또는 Media와 Source Post를 가진 Post Form 상태 값          |
...
- `Repost`와 `Quote`는 별도 durable 객체가 아니라 Post Form 값이다.
...
- [Post](../objects/post.md)는 Post Form, Post Visibility, Repost, Quote, Post Eligibility를 소유한다.
