...
- Instance Type은 Local, Remote 값을 가지며 모든 Profile은 같은 Origin 값을 가진 Instance 하나와 연결된다.
...
- Local Instance는 Normal/Reachable/Active를 유지하고 safety/reachability/service 상태 변경은 Remote
  Instance에만 적용한다.
