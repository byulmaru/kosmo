...
- [x] **Step 1: 실패하는 migration catalog assertion 작성**
...
- [x] **Step 3: Drizzle schema에 최소 index 선언**
...
- [x] **Step 4: 이름이 지정된 forward migration 생성 및 test에 적용**
...
- [x] **Step 5: GREEN과 migration 회귀 확인**
...
- [x] **Step 6: index checkpoint local commit**
