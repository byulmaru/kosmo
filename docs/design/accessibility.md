...
- Web은 Reply·Repost·Reaction 64×36px, Bookmark 50×36px, More 28×36px bounded target을 사용한다. 각 target은 24×24 CSS px 자체를 포함하고 인접 action이나 action 사이 분배 여백을 덮지 않아야 한다.
