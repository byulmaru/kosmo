...
- PostMediaViewer는 DSN-63 계약의 black 70% fullscreen media overlay를 사용하며 표준 black 45% scrim으로 통일하지 않는다. Control의 fixed-white glyph·dark halo와 transient Hover·Pressed layer를 유지하고 persistent circle은 사용하지 않는다.
