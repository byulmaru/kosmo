...
state_policy='{"Version":"2012-10-17","Statement":[{"Sid":"TerraformStateBucket","Effect":"Allow","Action":"s3:ListBucket","Resource":"arn:aws:s3:::byulmaru-terraform-state","Condition":{"StringLike":{"s3:prefix":"kosmo/firebase.tfstate*"}}},{"Sid":"TerraformState","Effect":"Allow","Action":["s3:GetObject","s3:PutObject"],"Resource":"arn:aws:s3:::byulmaru-terraform-state/kosmo/firebase.tfstate"},{"Sid":"TerraformStateLock","Effect":"Allow","Action":["s3:GetObject","s3:PutObject","s3:DeleteObject"],"Resource":"arn:aws:s3:::byulmaru-terraform-state/kosmo/firebase.tfstate.tflock"}]}'
