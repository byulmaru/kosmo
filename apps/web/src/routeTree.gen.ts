...
const MainAtChar123handleChar125Route = MainAtChar123handleChar125RouteImport.update({
  id: '/@{$handle}',
  path: '/@{$handle}',
  getParentRoute: () => MainRoute,
} as any);
...
export interface FileRouteTypes {
  ...
  id: '__root__' | '/_main' | '/_main/@{$handle}' | '/_main/' | '/_main/@{$handle}/following';
...
const MainAtChar123handleChar125RouteChildren: MainAtChar123handleChar125RouteChildren = {
  MainAtChar123handleChar125FollowingRoute: MainAtChar123handleChar125FollowingRoute,
};

const MainAtChar123handleChar125RouteWithChildren =
  MainAtChar123handleChar125Route._addFileChildren(MainAtChar123handleChar125RouteChildren);
