...
const initialFormState: ContentReportFormState = { dirty: false, submitting: false };
...
export function ContentReportOverlay({ onRequestClose, target, visible }: Props) {
  ...
  const handleFormStateChange = useCallback((nextState: ContentReportFormState) => {
      ...
      >
        ...
        >
          <View
            ...
            ref={mainRef}
            style={[styles.main, mobile ? styles.mobileMain : null]}
          >
            ...
            {target ? (
              <ScrollView
                ...
                testID="content-report-overlay-body"
              >
                <ContentReportForm
                  key={formRevision}
          ...
          {discardConfirmOpen ? (
            ...
            >
              <View
                ...
                accessibilityLabel="작성 중인 신고를 버릴까요?"
                accessibilityViewIsModal
