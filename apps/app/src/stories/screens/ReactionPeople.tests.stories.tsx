...
import type { ReactionPeopleExampleProps } from './ReactionPeople.fixtures';
...
function RemountablePeople(props: ReactionPeopleExampleProps) {
...
function ActorSwitchPeople(props: ReactionPeopleExampleProps) {
