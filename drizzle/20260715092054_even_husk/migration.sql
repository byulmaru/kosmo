...
ALTER TABLE "profile_follow_request" ADD COLUMN "inbound_follow_generation" timestamp with time zone;--> statement-breakpoint
...
ALTER TABLE "profile_follow" ADD COLUMN "inbound_follow_object_uri" text;--> statement-breakpoint
ALTER TABLE "profile_follow" ADD COLUMN "inbound_follow_generation" timestamp with time zone;