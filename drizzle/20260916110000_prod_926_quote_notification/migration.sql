...
ALTER TABLE "notification_quote_judgment" ADD CONSTRAINT "notification_quote_judgment_Pmd8PxLJM9hf_fkey" FOREIGN KEY ("recipient_profile_id") REFERENCES "profile"("id") ON DELETE CASCADE;
