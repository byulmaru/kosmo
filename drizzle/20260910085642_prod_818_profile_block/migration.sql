...
CREATE TYPE "profile_block_activity_state" AS ENUM('ACTIVE', 'CLOSED');--> statement-breakpoint
CREATE TYPE "profile_block_delivery_state" AS ENUM('NONE', 'SETTLED');--> statement-breakpoint
...
CREATE UNIQUE INDEX "profile_block_activity_active_pair_unique" ON "profile_block_activity" ("owner_profile_id","target_profile_id") WHERE "profile_block_activity"."state" = 'ACTIVE';--> statement-breakpoint
