    ...
    `
      ...
      BEGIN
        ...
        IF NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'kosmo_worker') THEN
          CREATE ROLE kosmo_worker LOGIN INHERIT NOSUPERUSER NOCREATEDB NOCREATEROLE NOREPLICATION NOBYPASSRLS;
        END IF;
      END
      $bootstrap$;
      ALTER ROLE kosmo_api LOGIN INHERIT NOSUPERUSER NOCREATEDB NOCREATEROLE NOREPLICATION NOBYPASSRLS;
      ALTER ROLE kosmo_worker LOGIN INHERIT NOSUPERUSER NOCREATEDB NOCREATEROLE NOREPLICATION NOBYPASSRLS;
      COMMIT;
    `,
  ]);
}
