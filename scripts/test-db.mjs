  ...
  runPostgresCommand([
    ...
    `
      ...
      BEGIN
        ...
        END IF;
        IF NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'kosmo_runtime') THEN
          CREATE ROLE kosmo_runtime LOGIN INHERIT NOSUPERUSER NOCREATEDB NOCREATEROLE NOREPLICATION NOBYPASSRLS;
        END IF;
      END
      $bootstrap$;
      ...
      ALTER ROLE kosmo_runtime LOGIN INHERIT NOSUPERUSER NOCREATEDB NOCREATEROLE NOREPLICATION NOBYPASSRLS;
      COMMIT;
    `,
  ]);
}
