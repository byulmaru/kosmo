...
Read this entire file when changing Relay documents, actor environments, mutations, normalized state, or connection updates. Use the generic `relay-best-practices` and `relay-performance` references when their broader Relay guidance is needed.
