...
| 기록                 | 남길 내용                                                                                                                                                       | 남기지 않을 내용                                                          |
| -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| Canonical domain/ADR | 사용자·시스템 결과, 비즈니스 규칙, 권한·보안·호환성 보장, 운영·롤아웃 제약과 결정 이유. 외부에서 강제한 기술 형태는 source와 필요한 이유·범위만 예외적으로 기록 | 함수·파일·테이블·payload·framework·구현 순서, 팀의 기술 선호              |
